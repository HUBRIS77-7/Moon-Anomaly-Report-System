	...
	#---------------DAY 2-----------------
{
	...
	
	{
		"id":                 16,
		"day":                3,
		"caller_name":        "[UNKNOWN CALLER; SAT PHONE]",
		"caller_photo":       "",
		"duration":           60.0,
		"audio":              "",
		"transcription": "H-hello? Is somebody on the line? There's a man... *crash* He got into my apartment... and *bang*, he's looking through the place, taking anything not bolted down. I know he has a gun! Please send somebody. Please.",
		"additional_details": "",
		"correct_anomaly_id": 27,
		"tasks":              [],
		"icon_direction": Vector3(0.711, -0.515, 0.479),
		"theme_tags":         [],
		"exclusive_to_week":  "",
	},
	{
		"id":                 17,
		"day":                3,
		"caller_name":        "Lunar Biologist Harold",
		"caller_photo":       "",
		"duration":           60.0,
		"audio":              "",
		"transcription": "Have you ever looked outside? When is the last time that you did? Really apriciated the beauty that surrounds us all? The circumstances that brought us to this point are astounding. Almost impossible even. Like the moon goddess herself brought us to rest amongst it's surface.",
		"additional_details": "Harlod's Biotag has him attempting to access the airlock of the station he is on, despite lacking proper permissions.",
		"correct_anomaly_id": 17,
		"tasks":              [],
		"icon_direction":     Vector3(0, 1, 0),
		"theme_tags":         [],
		"exclusive_to_week":  "",
	},
	{
		"id":                 18,
		"day":                3,
		"caller_name":        "Detective Sher",
		"caller_photo":       "",
		"duration":           60.0,
		"audio":              "",
		"transcription":      "Hello, this is Detective Sher. I'd call into CommNet, but my radio is on the fritz. I'm tracking down this missing person's case, and it's lead me to the middle of... nowhere. I got this tunnel in front of me. Nothing official, I haven't passed a man-made... anything in the past 30 minutes.\nI can't wait forever, though. I gotta get down there.",
		"additional_details": "Detective Sher's vehicle is registered under ID: 7Z-09-CR-14",
		"correct_anomaly_id": 28,
		"tasks": [],
		"icon_direction":     Vector3(0.000, 1.000, 0.000),
		"theme_tags":         [],
		"exclusive_to_week":  "training",
	},
	{
		"id":                 19,
		"day":                3,
		"caller_name":        "Spaceport Administrator Derek",
		"caller_photo":       "",
		"duration":           60.0,
		"audio":              "",
		"transcription":      "Hey, there, policy says I have to call you guys whenever this happens... which isn't a lot by the way! We're a very reputable spaceport, but, uh, we don't have the greatest security record... These calls aren't public right? Anyway! We caught this gang of kids sneaking into the cargo yard, spraypainting the containers and stuff. I don't know what that's filed as, but policy says to let you guys sort it out.",
		"additional_details": "The mechanics at Terry's Fine And Dandy Spaceport have reported that 7 Automated Cargo Transportation Units have had their navigation units smashed. Use of these units would cause the vehicles to crash.",
		"correct_anomaly_id": 54,
		"tasks": [],
		"icon_direction":     Vector3(0.000, 1.000, 0.000),
		"theme_tags":         [],
		"exclusive_to_week":  "training",
	},
	{
		"id":                 20,
		"day":                3,
		"caller_name":        "Street Technician Rey",
		"caller_photo":       "",
		"duration":           60.0,
		"audio":              "",
		"transcription":      "Get his ass! Get him! *thump* Crap, I think I dialed someone.",
		"additional_details": "",
		"correct_anomaly_id": 9,
		"tasks": [],
		"icon_direction":     Vector3(0.000, 1.000, 0.000),
		"theme_tags":         [],
		"exclusive_to_week":  "training",
	},
	{
		"id":                 21,
		"day":                3,
		"caller_name":        "Nectaris Representative 07",
		"caller_photo":       "",
		"duration":           60.0,
		"audio":              "",
		"transcription":      "This is Nectaris Representative 07 covering all stations within the Apollo Radius. We just heard from our Security Cable that we have some unauthorized space-suits out and about. Did some hunting and found the source. Be a dear and file it in so I can get my bounty",
		"additional_details": "Nectaris Representatives can claim bounties for discovering areas used for the production of illegal EVA suits",
		"correct_anomaly_id": 32,
		"tasks": [],
		"icon_direction":     Vector3(0.000, 1.000, 0.000),
		"theme_tags":         [],
		"exclusive_to_week":  "training",
	},
	{
		"id":                 22,
		"day":                3,
		"caller_name":        "Secretary Lori",
		"caller_photo":       "",
		"duration":           60.0,
		"audio":              "",
		"transcription":      "Get the hell out of there! Hello? Is this M.A.R.S? My boss just locked himself in his damn rocket and is trying to take off! The thing doesn't have any fuel, but that certainly isn't stopping him. Get out!",
		"additional_details": "",
		"correct_anomaly_id": 35,
		"tasks": [],
		"icon_direction":     Vector3(0.000, 1.000, 0.000),
		"theme_tags":         [],
		"exclusive_to_week":  "training",
	...
	# --------DAY 4; SCIENCE(BIO/GEO/SCI)-------
	{
		"id":                 23,
		"day":                4,
		"caller_name":        "Scientific Assistant; Hue Bee.",
		"caller_photo":       "",
		"duration":           60.0,
		"audio":              "",
		"transcription":      "Hey, so, I was going out to get some samples from a ice drill, right, and I almost tripped over something. So, I go to dig it out of the regolith, and it's a whole damn rover! Not a modern one, an old one. Like... uh... What's the one? The sad one? Integrity? Discovery? One of those. Anyhow, brought it back to my lab at Nectar Station, can you have someone pick it up? I don't have a use for it, and I'm not sure if I can legally own it at all.",
		"additional_details": "",
		"correct_anomaly_id": 83,
		"tasks": [],
		"icon_direction":     Vector3(0.000, 1.000, 0.000),
		"theme_tags":         [],
		"exclusive_to_week":  "training",
	},
	{
		"id":                 24,
		"day":                4,
		"caller_name":        "Geologist: Daniel Young",
		"caller_photo":       "",
		"duration":           60.0,
		"audio":              "",
		"transcription":      "Hello?! We're broadcasting on all available frequencies, can anyone read us and respond? We were sent out to retrieve deep core samples from Mining Platform ZZZ-7, a platform located in a cave... I forget the name of it... It's the one with that stupid looking rock that looks like a cat. Before we could even get into the platform, the entire cave fell in on us. There's no other way out. We have enough oxy to last us the week, but we need help! Please respond!",
		"additional_details": "",
		"correct_anomaly_id": 21,
		"tasks":              [],
		"icon_direction":     Vector3(0, 1, 0),
		"theme_tags":         [],
		"exclusive_to_week":  "training",
	},
	{
		"id":                 25,
		"day":                4,
		"caller_name":        "Astronomist: Henry Dade",
		"caller_photo":       "",
		"duration":           60.0,
		"audio":              "",
		"transcription":      "There's something out here with me. I can hear it through the radio. It's taunting me. I swear to God, it's taunting me. Running back old Apollo tapes. *creaking noise* GET AWAY FROM ME.",
		"additional_details": "",
		"correct_anomaly_id": 62,
		"tasks":              [],
		"icon_direction":     Vector3(0, 1, 0),
		"theme_tags":         [],
		"exclusive_to_week":  "training",
		...
		"id":                 26,
		"day":                4,
		"caller_name":        "Sector Monitor: Ryan Tran",
		"caller_photo":       "",
		"duration":           60.0,
		"audio":              "",
		"transcription":      "Hey, so... *Explosion* You heard that, right? Yeah, this keeps happening whenever the sun hits us. I've called Landscaping for 5 weeks straight about ripping up the regolith and replacing it with something more stable, but they haven't come yet. Would you mind filing a report? I really need this done.",
		"additional_details": "",
		"correct_anomaly_id": 80,
		"tasks":              [],
		"icon_direction":     Vector3(0, 1, 0),
		"theme_tags":         [],
		"exclusive_to_week":  "training",
	},
	{
		"id":                 27,
		"day":                4,
		"caller_name":        "Janitor: Marvin Hall",
		"caller_photo":       "",
		"duration":           60.0,
		"audio":              "",
		"transcription":      "I got contracted to clean up this abandoned station for repurposement, apparently it was left for scraps for some reason a couple of decades ago, but all the life-support and radiation protection is till functional, so--. That's besides the point. I've been trying to scrub out this damn grease from the kitchen, but it just keeps coming back! Is there some special cleaner for this stuff or am I stupid?",
		"additional_details": "All windows within Abandoned C-27 are currently open. ",
		"correct_anomaly_id": 74,
		"tasks":              [],
		"icon_direction":     Vector3(0, 1, 0),
		"theme_tags":         [],
		"exclusive_to_week":  "training",
	},
	{
		"id":                 28,
		"day":                4,
		"caller_name":        "Artifical Intelligence: X-SCI-12/ JOY MULTIPLICATION",
		"caller_photo":       "",
		"duration":           60.0,
		"audio":              "",
		"transcription":      "WARNING! REALITY DESTABILIZATION DETECTED. TEMPERATURE READINGS INCONSISTENT ACROSS LARGE REGIONS OF THE MOON. HIGHEST READING: 15,700,000 KELVIN.\n\nEVACUATION REQUIRED.",
		"additional_details": "This is not true",
		"correct_anomaly_id": 5,
		"tasks":              [],
		"icon_direction":     Vector3(0, 1, 0),
		"theme_tags":         [],
	...
	},
	{
		"id":                 29,
		"day":                4,
		"caller_name":        "Civilian: John Hand",
		"caller_photo":       "",
		"duration":           60.0,
		"audio":              "",
		"transcription":      "IT BURNS! OH MY GOD! IT BURNS! HELP ME! HELP!",
		"additional_details": "",
		"correct_anomaly_id": 117,
		"tasks":              [],
		"icon_direction":     Vector3(0, 1, 0),
		"theme_tags":         [],
		"exclusive_to_week":  "training",
